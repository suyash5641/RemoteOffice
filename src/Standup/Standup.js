    ...
    <>
      <div className="standup-main-body">
        ...
        <div className="main-heading">
          ...
          <textarea className="standup-input" type="text" onChange={(e) => setYesterday(e.target.value)}></textarea>
        </div>
        <div className="main-heading">
          <div>
            <span className="standup-heading">What I Will Do Today ?</span>
          </div>
          <textarea className="standup-input" type="text" onChange={(e) => setToday(e.target.value)}></textarea>
        </div>
        <div className="bttn">
          <Button
            variant="contained"
        ...
        <div className="standup-footer">
          <div className="div-last">
            ...
            <span className="last-txt" onClick={handleClick}>
              Previous Standup
            </span>
          </div>
