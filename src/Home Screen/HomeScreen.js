      ...
      <div className="Home-body">
        ...
        <div className="poster">
          ...
          <div className="text-m">
            ...
            <span className="message">
              & Fight against <span className="new-message">COVID-19</span>
            </span>
          </div>
        </div>
        <div className="new-div">
          <div className="start">
            <div className="start-one">
              ...
              <span className="text-one">
                <span className="txt-div">{sickleave}/</span>
                {totalsickleave}
              </span>
            </div>
            <div className="start-new1">
              ...
              <span className="text-one">
                <span className="txt-div">{casualleave}/</span>
                {totalcasualleave}
              </span>
            </div>
            <div className="start-new1">
              ...
              <span className="text-one-one">
                <span className="txt-divone">{otherleave}/</span>
                {totalotherleave}
              </span>
            </div>
          </div>
          <div className="setdiv">
            ...
            <span className="text-two" onClick={handleClick}>
              Leaves
            </span>
          </div>
        </div>
        ...
        <div className="ft">
          ...
          <img src={calendericon} alt="calender" className="setcalendericon" onClick={() => history.push("/Holiday")}></img>
        </div>
      </div>
    </>
  );
